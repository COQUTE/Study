...
CREATE TABLE TB_STUDENT (
	...
	MANAGER_ID VARCHAR2(3 BYTE), -- 지도 교수
...
CREATE TABLE TB_DEPARTMENT (
	...
	HEAD_PROF VARCHAR2(3 BYTE) NOT NULL, -- 학과장
...
CREATE TABLE TB_COURSE_HISTORY (
	...
	ATTEND_SCR NUMBER NOT NULL, -- 출석 점수
	MID_SCR NUMBER NOT NULL, -- 중간고사
	FIN_SCR NUMBER NOT NULL, -- 기말고사
	ETC_SCR NUMBER NOT NULL, -- 기타 점수
	TOTAL_SCR NUMBER NOT NULL, -- 총점
...
CREATE TABLE TB_CLUB (
	...
	CLUB_NAME VARCHAR2(60 BYTE) NOT NULL, -- 동아리 이름
